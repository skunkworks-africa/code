...
const payload = await tS();
 ...
 temp=payload.map((object) => {
  ...
  const {TITLE, OVERVIEW,JOB_ROLE,COURSECODE,SKILLLEVEL,OBJECTIVE,DURATION,DURATION_UNIT} = object;
  
  return `
  <link rel="stylesheet" href="./coursec/coursestyles.css">

  <div class="header">
        <img class="sl-030822-49070-19-2" src="./coursec/sl-030822-49070-19-20.png" />
      ...
      <div class="body">
        ...
        <img class="rectangle-33" src="./coursec/rectangle-330.png" />
        ...
        <div class="time-choice">
          ...
          <div class="button">
            <div class="button-content">
              ...
              <div class="icon">
                <img class="add" src="./coursec/add0.svg" />
              </div>
            </div>
          </div>
        ...
        <div class="objectives">Objectives
        ...
        <div class="course-overview">Course Overview
        ...
        <div class="badge-frame">
          ...
          <img class="pages-line-2" src="./coursec/pages-line-20.svg" />
        </div>
      </div>
  ...
  `
   ...
   temp=payload.map((object) => {
    ...
    return `
    <link rel="stylesheet" href="./badge/badgestyles.css">
    
    <div class="body">
      <div class="io-t-banner">
        <img class="oip-2" src="./badge/oip-20.png" />
      ...
      <div class="badge">
        ...
        <img class="vector3" src="./badge/vector2.svg" />
        <div class="io-t-maximo-domains2">${TITLE}</div>
        <img class="cyber-badges-1" src="./badge/cyber-badges-10.png" />
